...
CARD_FRONT = "D:\Personale\Coding\Python\Angela\Projects\\flash-card-project\images\card_front.png"
CARD_BACK = "D:\Personale\Coding\Python\Angela\Projects\\flash-card-project\images\card_back.png"
WRONG_BTN_IMAGE = "D:\Personale\Coding\Python\Angela\Projects\\flash-card-project\images\wrong.png"
RIGHT_BTN_IMAGE = "D:\Personale\Coding\Python\Angela\Projects\\flash-card-project\images\\right.png"
DATA_FILE = "D:\Personale\Coding\Python\Angela\Projects\\flash-card-project\data\\french_words.csv"
WORDS_TO_LEARN = "D:\Personale\Coding\Python\Angela\Projects\\flash-card-project\data\\words_to_learn.csv"
window = Tk()
window.title("Flashy")
...
def next_card():
    ...
    try:
        ...
        canvas.itemconfigure(card_title, text="No more words to learn")
        canvas.itemconfigure(card_word, text="Congratulations!")
    else:
